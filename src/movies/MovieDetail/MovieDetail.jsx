...
export function MovieDetail() {
  ...
  return (
    <div className="mx-3">
      <Link
        to="/"
        className="text-indigo-500 font-bold uppercase py-2 text-sm outline-none mr-1 mb-1"
      >
        &lt; Back to List
      </Link>
      <div className="mb-6">
        <h1 className="text-4xl font-normal leading-normal mt-0 mb-2 text-blueGray-800">
          {info.title}
          <br />
          <small className="font-normal leading-normal mt-0 mb-4 text-blueGray-800">
            {info.tagline}
          </small>
        </h1>
        <p>{genres}</p>
